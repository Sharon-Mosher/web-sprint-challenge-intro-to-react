...
ReactJs is a JS library that makes it easier for developers to build changing user interface using components so they don't have to write alot of cade.

1. Describe component state. 

Component state determines how an object renders and behaves. Allows you to create components that are dynamic and interactive.

1. Describe props.

Props is used to pass data from component to component.

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?

Side effects are anything that affects something outside of the scope of the current function. You use useEffect to sync effects in React.
